...
4. [AHB3-Lite](rtl/ahbscope.v)
5. [Memory backed scope, using AXI](rtl/memscope.v).  This is great for when
...
6. [_Compressed_ Memory backed scope, using AXI](rtl/memscopc.v).  This uses the
